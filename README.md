...
curl -X POST -H "Accept: application/vnd.github.v3+json" -H "Authorization: Bearer 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" -d '{"ref":"main"}' https://api.github.com/repos/rmit-computing-technologies/cosc2759-assignment-2-LukeMacdonald/actions/workflows/pipeline.yml/dispatches 
